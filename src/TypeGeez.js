...
dictionary.set('ca', ['ጫ', 'ቻ'])
dictionary.set('ce', ['ጨ', 'ቸ'])
dictionary.set('ci', ['ጪ', 'ቺ'])
dictionary.set('co', ['ጮ', 'ቾ'])
dictionary.set('cu', ['ጩ', 'ቹ'])
dictionary.set('c', ['ጭ', 'ች'])

dictionary.set('pa', ['ፓ', 'ጳ'])
dictionary.set('pe', ['ፐ', 'ጰ'])
